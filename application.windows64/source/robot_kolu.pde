...
float xm, ym, am, qm;
float Y, alt;
float q = 0.;//(ikinci kolun yatayla yaptığı başlangıç açısı
float a = 0.;//birinci kolun yatayla yaptığı başlangıç açısı
...
void kolGosterl1(float a){
 ...
 void kolGosterl2(float a, float q){
